  ...
  return (
    <div className='flex flex-col items-center justify-center gap-4 w-full min-h-screen text-center p-6'>
      ...
      <motion.p
        ...
        className='text-gray-600 mt-4 text-lg md:text-xl max-w-lg'>
        {"Your one stop shop for all your grocery needs and fresh products delivered to your doorstep.".split(" ").map((word, index) => (
          <motion.span
            key={index}
            variants={{
              hidden: {
